...
The LAST agent must run verification using available THB skills:
- Use `vulnerability-scanner` skill for security audit
- Use `test-driven-development` skill to verify test coverage
- Use `systematic-debugging` skill if issues found
